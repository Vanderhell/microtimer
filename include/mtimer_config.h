...
#if defined(MTIMER_MAX_TIMERS)
#define MTIMER_CONFIG_REQUESTED_MAX_TIMERS MTIMER_MAX_TIMERS
#else
#define MTIMER_CONFIG_REQUESTED_MAX_TIMERS MTIMER_CONFIG_RESOLVED_MAX_TIMERS
#endif

#if (MTIMER_CONFIG_REQUESTED_MAX_TIMERS < 1)
#error "microtimer: MTIMER_MAX_TIMERS must be >= 1"
#endif

#if (MTIMER_CONFIG_REQUESTED_MAX_TIMERS > 255)
#error "microtimer: MTIMER_MAX_TIMERS must be <= 255 with uint8_t ids"
#endif

#if defined(MTIMER_MAX_TIMERS) && (MTIMER_CONFIG_REQUESTED_MAX_TIMERS != MTIMER_CONFIG_RESOLVED_MAX_TIMERS)
...
#undef MTIMER_CONFIG_REQUESTED_MAX_TIMERS
